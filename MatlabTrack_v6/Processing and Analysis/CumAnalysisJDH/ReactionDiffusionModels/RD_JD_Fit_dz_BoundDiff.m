function [FitPar, FitParSigma, FitSSR Fit] = RD_JD_Fit_dz_BoundDiff(Data, Par, Ini, plotFlag)
...
FitParUB = [Inf, Inf, Inf, Inf, 10];

% prepare function for fit
fitfun = @(COEF) (RD_JD_Fun_dz_BoundDiff(COEF, Par) - Data);
...
Fit = RD_JD_Fun_dz_BoundDiff(FitPar, Par);
