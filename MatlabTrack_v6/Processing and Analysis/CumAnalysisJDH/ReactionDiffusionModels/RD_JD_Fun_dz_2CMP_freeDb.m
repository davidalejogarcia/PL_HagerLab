function [OUT] = RD_JD_Fun_dz_2CMP_freeDb(COEF, PAR)
...
COEF_D1 = [D1, f1*n, kon, koff, deltaZ, Db];
COEF_D2 = [D2, (1-f1)*n, kon, koff, deltaZ, Db];

OUT1 =  RD_JD_Fun_dz_BoundDiff_freeDb(COEF_D1, PAR);
OUT2 =  RD_JD_Fun_dz_BoundDiff_freeDb(COEF_D2, PAR);
