function [FitPar, FitParSigma, FitSSR, Fit] = RD_JD_Fit_dz_2CMP_fixedk(Data, Par, Ini, plotFlag)
...
% Par{5} = [kon, koff] reaction rates, fixed.
%
...
fitfun = @(COEF) (RD_JD_Fun_dz_2CMP_fixedk(COEF, Par) - Data);
...
Fit = RD_JD_Fun_dz_2CMP_fixedk(FitPar, Par);
