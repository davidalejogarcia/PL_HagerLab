function [ArrivalTimes_rel, DepartTimes_rel, coboundTracks1,coboundTracks2] = calculateRelTiming2(ImmTracks1,ImmTracks2,ThreshH)
...
for i = 1:nTracks1
    ...
    for j = 1:nTracks2
        ...
        if dist <= ThreshH && ~isempty(overlap_frames)
            curColoc = [i j];
...
for i = 1:size(colocTrks,1)
    ...
    ArrivalTimes_rel = [ArrivalTimes_rel; (avgTrk2(trk2,3) - avgTrk1(trk1,3))];
    DepartTimes_rel = [DepartTimes_rel; (avgTrk2(trk2,4) - avgTrk1(trk1,4))];
