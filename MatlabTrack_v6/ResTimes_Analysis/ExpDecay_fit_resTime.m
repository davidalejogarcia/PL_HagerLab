function [Esp_Coef, Esp_Sigma, Esp_Fit] = ExpDecay_fit_resTime(data, k0)
...
fitfun = @(COEF) (ExpDecay_fun_resTime(COEF, tlist) -Y);
...
% Compute output
Esp_Fit(:,1) = data(:,1);
Esp_Fit(:,2)= ExpDecay_fun_resTime(Esp_Coef,Esp_Fit(:,1));
